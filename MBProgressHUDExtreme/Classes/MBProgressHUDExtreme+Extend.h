//
//  MBProgressHUDExtreme+Extend.h
//  MBProgressHUDExtreme
//
//  Created by James Li on 2019/7/12.
//

#import <MBProgressHUDExtreme/MBProgressHUDExtreme.h>
...
@interface MBProgressHUDExtreme (Extend)
...
/**
 ...
 @param configHud 配置hud其它属性
 */
- (MBProgressHUDExtreme *)createHudToView:(UIView *)view
                             title:(NSString *)title
                         configHud:(NHCurrentHud)configHud;
